...
class MainActivity : AppCompatActivity() {
    ...
    myDataList.add(UserData("Shaloo","shaloo@gmail.com","35443543154"))
    myDataList.add(UserData("john","john@polimera.com","009uuioj"))
    myDataList.add(UserData("sam","sam@kumar.com","627834627g"))
    myDataList.add(UserData("Rohan","jfsaisfDubfdai@mdfgsg.com","77541dsf77"))
    myDataList.add(UserData("James","jasdsgssgsai@msgggsd.com","7718548277777"))
    ...
    myDataList.add(UserData("Edward","Edward@mdfdango.com","75265468"))
